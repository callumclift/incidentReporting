...
class GlobalFunctions {
  ...
  static Future<String> getStaticMap(
    ...
    try {
      ...
      staticMap = "https://maps.googleapis.com/maps/api/staticmap?zoom=13&size=500x300&maptype=roadmap&markers=color:orange%7C${latitude.toString()},${longitude.toString()}&key=$browserApi";
      print(staticMap);

    } catch (error) {
      print(error);
      showToast('Unable to fetch map');
    }
